...
public class OrderServiceImpl implements OrderService {
	...
	strB.append("<!DOCTYPE html>\r\n"
		...
		+ "                </div>\r\n"
		+ "                <div class='col-6'>\r\n"
		+ "                    <p class='sub-heading'>Full Name: " +userDAO.findByAccountUsername(order.getAccount().getUsername()).getFullname()+"</p>\r\n"
		+ "                    <p class='sub-heading'>Address: " + order.getAddress() + "</p>\r\n"
		+ "                    <p class='sub-heading'>Phone Number: " + userDAO.findByAccountUsername(order.getAccount().getUsername()).getPhone() + "</p>\r\n"
