...
public class InformationController {
	  ...
	  AccountService accountService;
	    ...
	    public String informationPage(HttpServletRequest request, Model model) {
	    	...
	    	List<OrderListDto> orders = orderService.findByUsername(username);
	    	if(orders.size() != 0) {
	    ...
	    public String updateAddress(Model model,@RequestParam("address") String address,@RequestParam("phone") String phone,HttpServletRequest request) {
	    	String username =  request.getRemoteUser();
